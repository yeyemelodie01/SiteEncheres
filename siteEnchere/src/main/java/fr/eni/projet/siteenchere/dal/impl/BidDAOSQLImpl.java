...
//        User user = this.userDAOInterface.findById(article.getUtilisateur().getNoUtilisateur());
//        Article findArticle = this.articleDAO.find(article.getNoArticle());
//
//        MapSqlParameterSource namedParameters = new MapSqlParameterSource().addValue("utilisateur", utilisateur.getNoUtilisateur()).addValue("noArticle", article.getNoArticle()).addValue("dateDebutEncheres", findArticle.getDateDebutEncheres()).addValue("miseAPrix", findArticle.getPrixInitial());
//
